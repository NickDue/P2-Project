...
function rotate(destinationX,destinationY,originX,originY) {  //Formål at ændre pilens retning i samarit.html fra samarit til rapportør
    ...
    arrow.style.transform = `rotate(${angleForVector.angle}deg)`    //Ændre style attributen transform i samarit.html
...
async function acceptButt (number) {
    ...
    await fetch(acceptAPI, { // fetch løser promisesen hvis stigen "acceptAPI" lykkedes
